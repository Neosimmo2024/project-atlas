...
type TaskFormProps = {
  mode: "create" | "edit";
  task?: Task;
  defaults?: Partial<Pick<Task, "person_id" | "organization_id" | "relationship_id" | "interaction_id" | "source_type" | "source_id">>;
...
export function TaskForm({ mode, task, defaults, peopleOptions, organizationOptions, relationshipOptions, interactionOptions }: TaskFormProps) {
