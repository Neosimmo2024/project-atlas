...
describe("security headers", () => {
  it("builds a restrictive CSP including configured Supabase and approved image origins", () => {
    ...
    expect(csp).toContain("img-src 'self' data: blob: https://extranet.neos-immo.com https://raw.githubusercontent.com");
