...
function sourceType(params: Record<string, string | string[] | undefined>): TaskSourceType {
  ...
  if (value === "person" || value === "organization" || value === "relationship" || value === "interaction") return value;
  return "manual";
}
...
export default async function NewTaskPage({ searchParams }: NewTaskPageProps) {
  ...
  const [peopleOptions, organizationOptions, relationshipOptions, interactionOptions] = context
    ? await Promise.all([
