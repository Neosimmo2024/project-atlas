...
export const CSV_IMPORT_FIELD_DEFINITIONS: CsvImportFieldDefinition[] = [
  ...
  { field: "organization_siren", label: "SIREN organisation", group: "professional" },
  { field: "organization_siret", label: "SIRET organisation", group: "professional" },
  { field: "organization_email", label: "E-mail organisation", group: "professional" },
  { field: "organization_phone", label: "Téléphone organisation", group: "professional" },
